...
import { Accordion, Flex, Tabs } from 'shadcn-plus';
...
export const Dashboard = () => {
  ...
  const features = [
    {
      ...
      description:
        'High-quality React components built on the latest design system, ready to use out of the box.',
    ...
    },
    {
      ...
      description:
        'Includes buttons, forms, navigation, data display and other commonly used components.',
  ...
  const testimonials = [
    {
      ...
      content:
        'shadcn-plus has greatly improved our development efficiency. The component quality is high and the documentation is comprehensive.',
      avatar:
    ...
    },
    {
      ...
      content:
        'This component library has a very modern design style and strong customizability, which perfectly meets our needs.',
      avatar:
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'You can install shadcn-plus via npm or pnpm, then configure and use it according to our documentation. We provide detailed installation guides and example code.',
    },
    {
      question: 'Which frameworks does shadcn-plus support?',
      answer:
        'shadcn-plus is primarily designed for React applications and supports mainstream React frameworks like Next.js, Vite, Create React App, etc.',
    },
    {
      question: 'Can I customize component styles?',
      answer:
        'Absolutely! shadcn-plus provides a flexible theming system where you can easily customize colors, fonts, spacing and other style properties, or perform deep customization through CSS variables.',
    },
    {
  ...
  return (
    ...
    >
      ...
      <main style={{ flex: 1 }}>
        {/* Hero Section */}
        <section
          style={{ width: '100%', padding: '80px 0 160px', overflow: 'hidden' }}
        >
          <div
            style={{
              maxWidth: '1200px',
