        ...
        <div style={{ color: '#6b7280', fontSize: '14px', lineHeight: '1.6' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div>
              ...
              <p style={{ margin: '0' }}>Receive real-time updates on your device.</p>
            </div>
            <div>
              <h4 style={{ margin: '0 0 4px 0', fontSize: '14px', fontWeight: '600', color: '#374151' }}>
                Email Notifications
              </h4>
              <p style={{ margin: '0' }}>Get important updates delivered to your inbox.</p>
            </div>
          </div>
        </div>
      ),
        ...
        <div style={{ color: '#6b7280', fontSize: '14px', lineHeight: '1.6' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div>
              ...
              <p style={{ margin: '0' }}>Manage your API keys and access tokens.</p>
            </div>
            <div>
              <h4 style={{ margin: '0 0 4px 0', fontSize: '14px', fontWeight: '600', color: '#374151' }}>
                Developer Tools
              </h4>
              <p style={{ margin: '0' }}>Access advanced developer features and debugging tools.</p>
            </div>
          </div>
        </div>
      ),
