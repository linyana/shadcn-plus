...
import { LayoutFlexComponent } from './component';

export const LayoutFlexExample = () => {
  return (
    <>
      <Heading level={5}>Common Layouts</Heading>
      <Component
        previewContent={<LayoutFlexComponent />}
        codeContent={`import { Button, Flex, Card, Input } from 'shadcn-plus';
