...
import { OrientationSeparatorComponent } from './component';

export const OrientationSeparatorExample = () => {
  return (
    <>
      <Heading level={5}>Orientation</Heading>
      <Component
        previewContent={<OrientationSeparatorComponent />}
        codeContent={`import { Separator, Flex } from 'shadcn-plus';
