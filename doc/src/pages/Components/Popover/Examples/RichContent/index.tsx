...
import { RichContentPopoverComponent } from './component';

export const RichContentPopoverExample = () => {
  return (
    <>
      <Heading level={5}>Rich Content</Heading>
      <Component
        previewContent={<RichContentPopoverComponent />}
        codeContent={`import { Popover, Button, Input, Flex } from 'shadcn-plus';
